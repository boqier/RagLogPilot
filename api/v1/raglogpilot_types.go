...
type RagLogPilot struct {
	...
	// spec defines the desired state of RagLogPilot
	// +required
	Spec RagLogPilotSpec `json:"spec"`

	// status defines the observed state of RagLogPilot
	// +optional
	Status RagLogPilotStatus `json:"status,omitempty,omitzero"`
}
